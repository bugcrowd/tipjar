...
|AWSBucketDump      | Security Tool to Look For Interesting Files in S3 Buckets | [https://github.com/jordanpotti/AWSBucketDump](https://github.com/jordanpotti/AWSBucketDump) | Free and Open Source    |
|gau                | Fetch known URLs from AlienVault's and the Wayback Machine| [https://github.com/lc/gau](https://github.com/lc/gau)                     | Free and Open Source    |
|gf                 | A wrapper around grep, to help you grep for things        |[https://github.com/tomnomnom/gf](https://github.com/tomnomnom/gf)                         | Free and Open Source    |
|gitleaks           |Scan git repos for secrets using regex and entropy 🔑     |[gitleaks](https://github.com/zricethezav/gitleaks)                                                 | Free and Open Source    |
|gitrob             |Reconnaissance tool for GitHub organizations              |[gitrob](https://github.com/michenriksen/gitrob)                                              | Free and Open Source    |
|graphql-voyager    |🛰️ Represent any GraphQL API as an interactive graph      |[graphql-voyager](https://github.com/APIs-guru/graphql-voyager)                              | Free and Open Source    |
|gron               |Make JSON greppable!                                       |[gron](https://github.com/tomnomnom/gron)                                                   | Free and Open Source    |
|BruteX             |Automatically brute force all services running on a target. |[BruteX](https://github.com/1N3/BruteX)                                                  | Free and Open Source    |
|CT_subdomains      | An hourly updated list of subdomains gathered from certificate transparency logs | [CT_subdomains](https://github.com/internetwache/CT_subdomains)| Free and Open Source    |
|Chaos Web |actively scan and maintain internet-wide assets' data. enhance research and analyse changes around DNS for better insights  | [Chaos Web](https://chaos.projectdiscovery.io)| Api key requered     |
|GitMiner   | Tool for advanced mining for content on Github |[GitMiner](https://github.com/UnkL4b/GitMiner)                                                                    | Free and Open Source    |
|Gopherus | This tool generates gopher link for exploiting SSRF and gaining RCE in various servers |[Gopherus](https://github.com/tarunkant/Gopherus)                          | Free and Open Source    |
|GraphQLmap | GraphQLmap is a scripting engine to interact with a graphql endpoint for pentesting purposes. |[GraphQLmap](https://github.com/swisskyrepo/GraphQLmap)| Free and Open Source    |
|LinkFinder | A python script that finds endpoints in JavaScript files | [LinkFinder](https://github.com/GerbenJavado/LinkFinder)                                          | Free and Open Source    |
|ParamSpider| Mining parameters from dark corners of Web Archives |[ParamSpider](https://github.com/devanshbatham/ParamSpider)                                                      | Free and Open Source    |
|PayloadsAllTheThings| A list of useful payloads and bypass for Web Application Security and Pentest/CTF |[PayloadsAllTheThings](https://github.com/swisskyrepo/PayloadsAllTheThings)| Free and Open Source    |
|SQLNinja|  SQL Injection scanner| [SQLNinja](https://gitlab.com/kalilinux/packages/sqlninja)                                                                                   | Free and Open Source    |
|SecLists | SecLists is the security tester's companion. It's a collection of multiple types of lists used during security assessments, collected in one place. List types include usernames, passwords, URLs, sensitive data patterns, fuzzing payloads, web shells, and many more. | [SecLists](https://github.com/danielmiessler/SecLists)| Free and Open Source    |
|SecretFinder |SecretFinder - A python script for find sensitive data | [SecretFinder](https://github.com/m4ll0k/SecretFinder)                                                                                                                                                             | Free and Open Source    |
|Sublist3r | Fast subdomains enumeration tool for penetration testers  | [Sublist3r](https://github.com/aboul3la/Sublist3r)| Free and Open Source    |
|xsscrapy |  XSS/SQLi python2 spider. Give it a URL and it'll test every link it finds for XSS and some SQLi. |[xsscrapy](https://github.com/DanMcInerney/xsscrapy) | Free and Open Source    |
|can-i-take-over-xyz| \"Can I take over XYZ?\" — a list of services and how to claim (sub)domains with dangling DNS records. | [can-i-take-over-xyz](https://github.com/EdOverflow/can-i-take-over-xyz) | Free and Open Source    |
|findomain   | The fastest and cross-platform subdomain enumerator, do not waste your time. | [findomain](https://github.com/Edu4rdSHL/findomain)           | Free and Open Source    |
